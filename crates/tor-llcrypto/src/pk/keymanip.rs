...
use pk::ed25519::{ExpandedKeypair, PublicKey};
...
pub fn convert_curve25519_to_ed25519_private(
    ...
    use crate::{d::Sha512, pk::ed25519::PublicKey};
    ...
    let public: pk::ed25519::PublicKey = PublicKey((&secret).into());
...
mod tests {
    ...
    fn curve_to_ed_compatible() {
        ...
        let ed_pk1: ed25519::PublicKey = ed25519::PublicKey((ed_sk).into());
